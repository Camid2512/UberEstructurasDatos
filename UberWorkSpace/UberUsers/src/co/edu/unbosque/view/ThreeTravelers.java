...
public class ThreeTravelers extends JFrame{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -188901602954170712L;
	...
	public ThreeTravelers() {
		...
		travelerOneName.setBounds(120, 270, 300, 70);
		...
		travelerOneDocument.setBounds(120, 337, 300, 70);
		...
		travelerTwoName.setBounds(480, 270, 300, 70);
		...
		travelerTwoDocument.setBounds(480, 337, 300, 70);
		...
		travelerThreeName.setBounds(830, 270, 300, 70);
		...
		travelerThreeDocument.setBounds(830, 337, 300, 70);
...
//		signUpBtn.setBorderPainted(false);
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/info3personas.png").getImage();
